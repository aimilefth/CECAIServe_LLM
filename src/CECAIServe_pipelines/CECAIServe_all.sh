...
dirs=("AGX_ORIN_LLM_LLAMA" "AGX_ORIN_LLM_VLLM" "AGX_ORIN_LLM_TRT" "ARM_LLM_LLAMA" "ARM_LLM_VLLM" "CPU_LLM_LLAMA" "CPU_LLM_VLLM" "GPU_LLM_LLAMA" "GPU_LLM_TRT" "GPU_LLM_VLLM" "Client")
native_trf_dirs=("AGX_ORIN_LLM_TRF" "ARM_LLM_TRF" "CPU_LLM_TRF" "GPU_LLM_TRF")
# Default values
input_path=""
mode="serial"
